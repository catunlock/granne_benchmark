...
mod test{
    ...
    fn test_from_str() {
        ...
        let input = "4ffa4021-0932-4835-bd92-19e92c047293/body/250c7835-1736-4776-afa0-08490c647cb0/10-20";
        let result = VectorIdentifier::from_str(input);

        assert_eq!(result, VectorIdentifier{
            doc_id: "4ffa4021-0932-4835-bd92-19e92c047293",
            field: "body",
            paragraph_id: "250c7835-1736-4776-afa0-08490c647cb0",
            start: 10,
            end: 20
        });
    }
